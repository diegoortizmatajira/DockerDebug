...
.PARAMETER Clean
Removes the image dockerdebug and kills all containers based on that image.
...
Build a Docker image named dockerdebug
#>
...
$imageName="dockerdebug"
$projectName="dockerdebug"
$serviceName="dockerdebug"
